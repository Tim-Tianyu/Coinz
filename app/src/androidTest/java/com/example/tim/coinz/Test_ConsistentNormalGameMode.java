...
public class Test_ConsistentNormalGameMode {
    ...
    @Test
    public void test_ConsistentNormalGameMode() {
        ...
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.editEmail),
                        childAtPosition(
                                ...
                                4),
                        isDisplayed()));
        appCompatEditText.perform(replaceText("tim.wang."), closeSoftKeyboard());
        ...
        textView2.check(matches(withText("Normal")));
    }
